  ...
  return (
   <div>
    <div className='w-full max-w-4xl'>
      <h1 className='head-text text-left ml-24 mt-4 font-bold text-2xl'>Home</h1>
           ...
           <div className='flex items-start justify-between'>
             <div className='flex w-full flex-1 flex-row gap-4'>
                ...
                <div className='flex w-full flex-col'>
                   <p className='mt-2 text-small-regular text-light-2 relative left-20'>Welcome to the blog page !</p>
