    ...
    <div className="w-full">
      ...
      <div className="w-1/2 ml-auto mr-auto">
        <div className="flex flex-col gap-3  ">
          <h1 className="text-6xl font-semibold">
            <span className="text-transparent  bg-clip-text bg-gradient-to-b from-orange-300 to-orange-700">
              DevCom-Roadmaps
            </span>
          </h1>
        </div>
        ...
        <div className="mr-auto ml-auto w-1/5 ">
          <p className=" mb-1 border-2  rounded-lg border-gray-500 text-center p-1 mt-6 z-2 bg-slate-800 relative ">
            Hot Topics!!
          </p>
        </div>
      </div>
      ...
      <div className=" gap-4 mt-9 flex justify-center  ">
        {videoTutorials.map((item, index) => (
          <div
            key={`video-${index}`}
            className="ml-auto mr-auto mt-5 border-2 border-gray-900 rounded-lg shadow-xl shadow-black w-64 h-79   transition-transform transform hover:scale-105"
          >
            <div
              onClick={() => openPopup(item.url)}
              className="flex flex-col gap-2  my-6 ml-auto mr-auto "
            >
              <Image
                src={item.coverImg}
                width={100}
        ...
        <div className="mt-40 mr-6">
          <button className=" underline rounded-lg px-1 bg-transparent hover:bg-cyan-950">
            more roadmaps..
          </button>
        </div>
      </div>
      ...
      <div>
        <div className="mr-auto ml-auto w-48 ">
          <p className=" mb-1 border-2  rounded-lg border-gray-500 text-center p-1 mt-16 z-2 bg-slate-800 relative ">
            Role Based Roadmaps
          </p>
        </div>
